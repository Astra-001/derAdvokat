...
if($_POST['einstellung_allg'])
{
	...
	if(!isset($msg_name) AND !isset($msg_vorname) AND !isset($msg_strasse) AND !isset($msg_plz) AND !isset($msg_ort) AND !isset($msg_beginn) AND !isset($msg_bis) AND !isset($msg_bereich) AND !isset($msg_funktion) AND !isset($msg_gehalt) AND !isset($msg_urlaub))
	{
		require_once("rtf/anstell_vertrag_befristet_rtf.php");
	}
}
else
{
...
$smarty->assign('contentTemplate', 'anstell_vertrag_befristet.tpl');