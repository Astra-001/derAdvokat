...
class SMTP {
  ...
  private ?array $error = null;     // error if any on the last call
  private ?string $helo_rply = null; // the reply the server sent to us for HELO
