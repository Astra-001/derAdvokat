...
$parText->ParFormat('justify');
    // Seite 2
        ...
        $sect->writeText($paragraf_1, $fontPar, $parPar);
            ...
            $paragraf_1_abs_4="(4) Der Mitarbeiter verpflichtet sich, für den Fall der rechtswidrigen und schuldhaften Nichtaufnahme der Arbeit oder der vertragswidrigen Beendigung des Arbeitsverhältnisses eine Vertragsstrafe zu zahlen. Die Vertragsstrafe darf das in der maßgeblichen Kündigungsfrist ansonsten enthaltene Arbeitsentgelt nicht besteigen. Abgesehen von dieser Begrenzung wird sie auf ein Bruttomonatsentgelt festgesetzt.";
    ...
    // Seite 2
        ...
        $sect->writeText($paragraf_6, $fontPar, $parPar);
            ...
            $paragraf_6_abs_2="(2) Nicht genommener Urlaub verfällt am 31.03. des Folgejahres ersatzlos, sofern der Mitarbeiter nicht aufgrund von Krankheit verhindert ist, den Urlaub zu nehmen. Wird Urlaub gewährt, wird dieser Urlaub zunächst auf den gesetzlichen Mindesturlaubsanspruch angerechnet und erst darber hinaus auf einen etwaigen darber hinaus zu gewährenden vertraglichen Anspruch.";
        ...
        $sect->writeText($paragraf_7, $fontPar, $parPar);
            ...
            $paragraf_7_abs_2="(2) Im Krankheitsfall ist der Mitarbeiter verpflichtet, dem Arbeitgeber sofort eine entsprechende Mitteilung zu machen und auf Verlangen des Arbeitgebers sofort, spätestens jedoch vor Ablauf des dritten Kalendertages nach Beginn der Arbeitsunfähigkeit eine ärztliche Bescheinigung ber die Arbeitsunfähigkeit vom ersten Tage an sowie ber deren voraussichtlichen Dauer vorzulegen. Dauert die Arbeitsunfähigkeit länger als in der Bescheinigung angegeben, so ist der Mitarbeiter verpflichtet, unverzglich eine neue ärztliche Bescheinigung vorzulegen, auch wenn der Zeitraum der Entgeltfortzahlung beschritten ist.";
            ...
            $paragraf_7_abs_5="(5) Abweichend von § 616 BGB wird bei vorbergehender unverschuldeter Arbeitsverhinderung aus in der Person des Arbeitnehmers liegenden Gründen für eine verhältnismäßig nicht erhebliche Zeit keine bezahlte Freistellung gewährt. Die Vergtungsfortzahlung im Krankheitsfall richtet sich nach den jeweiligen gesetzlichen Bestimmungen.";
        ...
        $sect->writeText($paragraf_9, $fontPar, $parPar);
            $paragraf_9_abs_1="(1) Der Mitarbeiter tritt seine Schadensersatzansprche insoweit an den Arbeitgeber ab, als er durch einen Dritten verletzt wird und der Arbeitgeber Vergütungsfortzahlung im Krankheitsfall leistet.";
	...
	//Paragraf 9
        ...
        $sect->writeText($paragraf_10, $fontPar, $parPar);
            ...
            $paragraf_10_abs_2="(2) Der Mitarbeiter verpflichtet sich, ber alle Angelegenheiten des Arbeitgebers und seiner Kunden strengste Verschwiegenheit zu wahren. Die Verschwiegenheit gilt auch nach der Beendigung des Arbeitsverhältnisses unverändert weiter.";
	...
	//Paragraf 12
        ...
        $sect->writeText($paragraf_13, $fontPar, $parPar);
            #$paragraf_13_abs_1="(1) Die Kndigung sowie Ergänzungen, Verlängerungen oder sonstige Ã„nderungen dieses Vertrages einschließlich dieser Klausel bedrfen zu ihrer Rechtswirksamkeit der Schriftform. Eine stillschweigende Verlängerung des Arbeitsverhältnisses ber den in § 1 Abs. 1 genannten Zeitraum ist ausgeschlossen. Sonstige Vereinbarungen außerhalb dieses Vertrages bestehen zwischen den Parteien nicht.";
            ...
            $paragraf_13_abs_2="(2) Die etwaige Unwirksamkeit einzelner Vertragsbestimmungen oder von Teilen hiervon, berührt nicht die Wirksamkeit der brigen Vereinbarungen.";
	...
	//Paragraf 13
        ...
        $foot->setPosition(2);
        $seite="Seite <pagenum /> von 6";
        $foot->writeText($seite, $fontSeite, $parSeite);
	$foot = &$rtf->addFooter('first');
 // Seite 5
//
//** TEXTS**//
$rtf->sendRtf('anstellungsvertrag_'.date('Y-m-d_H-i-s'));
?>
