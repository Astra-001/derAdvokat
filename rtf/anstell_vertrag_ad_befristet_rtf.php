...
$paragraf_2_abs_1="(1) Der Mitarbeiter wird für den Unternehmensbereich Vertrieb als Außendienstvertreter eingestellt. Erfüllungsort für die Arbeitsleistung ist der Betriebssitz. Der Arbeitgeber wird dem Mitarbeiter ein Vertriebsgebiet innerhalb ".$_POST['vertriebsgebiet']." zuzuweisen, das von dem Mitarbeiter zu bereisen ist.";
$paragraf_2_abs_2="(2) Der Arbeitgeber behält sich vor, den Mitarbeiter innerhalb des Unternehmens zu versetzen, wenn ihm dies bei Abwägung der betrieblichen und seiner persönlichen Belange zuzumuten ist. Dies schließt insbesondere die Versetzung in den Innendienst ein.";
...
$sect->writeText($paragraf_4_abs_7, $fontText, $parMText);
//Paragraf 4
...
$rtf->sendRtf('Anstellungsvertrag_fuer_Aussendienst_befristet'.date('Y-m-d_H-i-s'));
?>