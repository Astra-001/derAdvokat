...
switch($_POST['geschlecht'])
    ...
    $parPar->setSpaceAfter(15);	
		...
		case 2: $andr="Frau";
	      ...
	      $absatz5 = ($i+1).". Die von Ihnen bewohnte Wohnung soll von ".$andr." ".$verwname[$i]." genutzt werden. Hierbei handelt es sich um ".$mein." ".$verwshaft[$i].".<br />".$verwform[$i];
	...
	$cell->writeText('Unterschrift des/der Vermieter(s)', $fontPar, $parCellTabl);
	      $rtf->sendRtf('kundigung_wohnraum_verwandten_'.date('Y-m-d_H-i-s'));
?>
