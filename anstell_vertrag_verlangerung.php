...
if($_POST['einstellung_allg'])
{
	...
	if ($_POST['verlangerung']=='')
	{
	    $msg_verlangerung = "Bitte geben Sie - Verl&auml;ngerung bis zum - ein";
	    $smarty->assign('msg_dar', $msg_verlangerung);
	    $smarty->assign('msg_verlangerung', $msg_verlangerung);
	}
	if ($_POST['beginn']=='')
	{
	    $msg_beginn = "Bitte geben Sie - Datum des ersten Arbeitsvertrages - ein";
    ...
    switch($_POST['anzahl'])
    {
    	case 1: $anzahl="erste";break;
    	case 2: $anzahl="zweite";break;
    	case 3: $anzahl="dritte";break;
    }
	if(!isset($msg_name) AND !isset($msg_vorname) AND !isset($msg_strasse) AND !isset($msg_plz) AND !isset($msg_ort) AND !isset($msg_beginn) AND !isset($msg_verlangerung) AND !isset($msg_anzahl))
	{
		require_once("rtf/anstell_vertrag_verlangerung_rtf.php");
	}
}
else
{
...
$smarty->assign('contentTemplate', 'anstell_vertrag_verlangerung.tpl');