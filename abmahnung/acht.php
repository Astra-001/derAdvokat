...
switch($_POST['geschlecht'])
  ...
  $betreff="Abmahnung wegen Verstoß gegen das betriebliche Alkoholverbot";
...
$parPar->setSpaceAfter(15);
	...
	$absatz2 = "Sie haben am ".$_POST['datum_verstoss']." in unserem Betrieb Alkohol getrunken. In Ihrer Anhörung vom ".$_POST['anhorungs_datum']." haben Sie keine hinreichende Entschuldigung vorbringen können.";
	$absatz3 = "Sie haben damit gegen unsere Anordnung zur Einhaltung des betrieblichen Alkoholverbots verstoßen. Verstöße werden mit arbeitsrechtlichen Maßnahmen belegt. ";
	$absatz4 = "Als Arbeitgeber haben wir eine Fürsorgepflicht gegenüber unseren Mitarbeitern. Der Konsum von Alkohol während der Arbeitszeit kann zu erheblichen Störungen des betrieblichen Ablaufes führen. Unsere Anordnung eines Alkoholverbots dient der Erfüllung unserer gesetzlichen Verpflichtungen und dem Schutz der Gesundheit Ihrer Kollegen. ";
...
$rtf->sendRtf('acht_'.date('Y-m-d_H-i-s'));
?>
