...
$parPar->setSpaceAfter(15);	
	...
	$absatz2 = "Sie sind am ".$_POST['datum_verstoss'].", zu spät an Ihrem Arbeitsplatz erschienen. Sie erschienen erst um ".$_POST['ersch_tag']." Uhr an Ihrem Arbeitsplatz. Eine plausible Entschuldigung für Ihr Zuspätkommen konnten Sie bei der Anhörung vom ".$_POST['anhorungs_datum']." nicht abgeben.";
	$sect->writeText($absatz2, $fontPar, $parPar);
	$absatz3 = "Sie haben damit gegen Ihre arbeitsvertraglichen Verpflichtungen verstoßen, nach dem Ihre regelmäßige Arbeitszeit um ".$_POST['reg_arb_beginn']." Uhr beginnt.";
	$sect->writeText($absatz3, $fontPar, $parPar);
	$absatz4 = "Diese Verspätung können wir im Interesse eines ungestörten Geschäftsbetriebs nicht hinnehmen. Sie wissen, dass wir im Sinne eines ungestörten und planbaren Arbeitsablaufes für alle Mitarbeiter einen bestimmten Arbeitsbeginn festgelegt haben.";
	...
	$sect->writeText($absatz7."<br /><br /><br /><br /><br /><br />", $fontPar, $parPar);
...
$rtf->sendRtf('einz_'.date('Y-m-d_H-i-s'));
#}
?>
