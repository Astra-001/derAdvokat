...
$betreff="Abmahnung wegen Anzeigepflichtverletzung ";
...
$parPar->setSpaceAfter(15);
	...
	$absatz2 = "Sie sind am ".$_POST['datum_verstoss']." nicht zur Arbeit erschienen. Eine Information über Ihr Nichterscheinen vor Ihrem regulären Arbeitsbeginn hatten Sie uns nicht erteilt. Eine rechtzeitige Disposition war uns daher nicht möglich.";
	$absatz3 = "In Ihrer Anhörung vom ".$_POST['anhorungs_datum']." konnten Sie uns keine zufriedenstellende Begründung dafür geben, warum es Ihnen nicht möglich gewesen sein soll, rechtzeitig einen Anruf bei uns zu tätigen und uns von Ihrem Nichterscheinen zu informieren.";
	$absatz4 = "Die von Ihnen benannten Entschuldigungsgründe für Ihr Nichterscheinen zur Arbeit können wir akzeptieren. Jedoch gilt dies nicht für die verspätete Entschuldigung. Im Interesse eines ordnungsgemäßen Betriebsablaufs müssen wir darauf bestehen, unverzüglich von unseren Arbeitnehmern unterrichtet zu werden, wenn sie – aus welchem Grund auch immer – der Arbeit fernbleiben.";
	$absatz5 = "Wir weisen Sie heute auch noch einmal schriftlich darauf hin, dass wir das von Ihnen gezeigte Verhalten in unserem Betrieb nicht dulden. Es handelt sich um einen schwerwiegenden Verstoß gegen Ihre Verpflichtungen als Arbeitnehmer. Ein solches Verhalten werden wir nicht tolerieren können.";
...
$rtf->sendRtf('drei_'.date('Y-m-d_H-i-s'));
?>
