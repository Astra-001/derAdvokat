...
switch($_POST['geschlecht'])
  ...
  switch($_POST['beleid_anrede'])
  {
    case 1: $beleid_anrede="Herrn";
            $beleid_anrede1="Herr"; break;
    case 2: $beleid_anrede="Frau";
            $beleid_anrede1="Frau"; break;
  }
  $betreff="Abmahnung wegen Beleidigung";
...
$parPar->setSpaceAfter(20);
	...
	$absatz2 = "Sie haben am ".$_POST['datum_verstoss']." in unserem Betrieb ".$beleid_anrede." ".$_POST['beleid_name']." beleidigt, indem Sie ".$beleid_anrede." ".$_POST['beleid_name']." als ".$_POST['beleid_wort']." bezeichneten. In Ihrer Anhörung vom ".$_POST['anhorungs_datum']." haben Sie keine hinreichende Entschuldigung vorbringen können.";
	$absatz3 = "Mit Ihrem Verhalten haben Sie den Betriebsfrieden erheblich gestört. Verständlicherweise sind wir an einer kollegialen Atmosphäre in unserem Betrieb sehr interessiert. Durch Ihr Verhalten untergraben Sie unsere diesbezüglichen Bemühungen. Abgesehen hiervon weisen wir Sie darauf hin, dass Ihr Verhalten in strafrechtlicher Hinsicht Konsequenzen nach sich ziehen könnte, wenn ".$beleid_anrede1." ".$_POST['beleid_name']." einen Strafantrag bei den zuständigen Behörden stellen sollte.";
	$absatz4 = "Wir machen mit dieser Abmahnung deutlich, dass wir das von Ihnen gezeigte Verhalten in unserem Betrieb nicht dulden. Es handelt sich um einen schwerwiegenden Verstoß gegen Ihre Verpflichtungen als Arbeitnehmer und um ein unkollegiales Verhalten. Ein solches Verhalten werden wir nicht tolerieren können.";
...
$rtf->sendRtf('neun_'.date('Y-m-d_H-i-s'));
?>
