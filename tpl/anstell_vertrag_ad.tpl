...
<h1>Anstellungsvertrag Au&szlig;endienst</h1>
...
<tr>
	...
	<td colspan="2"><input type="text" name="gehalt" {if strlen($msg_vergutung)}class="error"{/if} value="{if isset($smarty.post.gehalt)}{$smarty.post.gehalt}{/if}" size="20" /> Euro</td>
</tr>
<tr>
