...
<tr>
	<td width="186">Befristung nach § 14 TzBfG vom </td>
	...
	<td>bis zum <input type="text" name="bis" {if strlen($msg_bis)}class="error"{/if} {if isset($smarty.post.bis)}value="{$smarty.post.bis}"{else}value="TT.MM.JJJJ" onfocus="this.value = ''"{/if} size="20" /></td>
</tr>
</table>
<br />
<table border="0" width="100%" cellpadding="5" class="contenttable">
...
<tr>
	...
	<td colspan="3"><input type="text" name="vertriebsgebiet" {if strlen($msg_vertriebsgebiet)}class="error"{/if} value="{if isset($smarty.post.vertriebsgebiet)}{$smarty.post.vertriebsgebiet}{/if}" size="20" /> zuweisen.</td>
</tr>
</table>
<br />
<table border="0" width="100%" cellpadding="5" class="contenttable">
...
<tr>
	<td class="fehlermeldung" colspan="4">{$msg_vergutung}</td>
</tr>
{/if}
<tr>
	<td bgcolor="#9FC6FF" colspan="4"><font color="white"><b>Verg&uuml;tung</b></font></td>
</tr>
<tr>
...
<tr>
	<td width="170">Erstattung der Reisekosten</td>
