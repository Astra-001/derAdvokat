...
<br />
<table border="0" width="100%" cellpadding="5" class="contenttable">
{if strlen($msg_arbeitszeit)}
<tr>
	<td colspan="4" class="fehlermeldung">{$msg_arbeitszeit}</td>
</tr>
{/if}
<tr>
...
<tr>
	...
	<td colspan="3"><input type="text" name="arbeitszeit" {if strlen($msg_arbeitszeit)}class="error"{/if} value="{if isset($smarty.post.arbeitszeit)}{$smarty.post.arbeitszeit}{/if}" size="5" /> Stunden</td>
</tr>
</table>
<br />
<table border="0" width="100%" cellpadding="5" class="contenttable">
...
<tr>
	<td colspan="3" class="fehlermeldung">{$msg_vergutung}</td>
</tr>
{/if}
<tr>
...
<tr>
	...
	<td><input type="radio" name="art_vergutung"  value="1" onclick="check_anstellung_arbeitsstunden_aushilfe()"  {if $smarty.post.art_vergutung == 1} checked="checked" {/if} /> Monatsbruttogehalt in H&ouml;he von </td>
	<td><input type="text" name="gehalt_monats_brutto" {if strlen($msg_vergutung)}class="error"{/if} value="{if isset($smarty.post.gehalt_monats_brutto)}{$smarty.post.gehalt_monats_brutto}{/if}" size="20" /> &euro;</td>
</tr>
<tr>
	<td><input type="radio" name="art_vergutung"  value="2" onclick="check_anstellung_arbeitsstunden_aushilfe()" {if $smarty.post.art_vergutung == 2} checked="checked" {/if} />Bruttostundenlohn in H&ouml;he von </td>
	<td><input type="text" name="gehalt_stunden_brutto" {if strlen($msg_vergutung)}class="error"{/if} value="{if isset($smarty.post.gehalt_stunden_brutto)}{$smarty.post.gehalt_stunden_brutto}{/if}" size="20" /> &euro;</td>
</tr>
</table>
<br />
<table border="0" width="100%" cellpadding="5" class="contenttable">
