<?php /* Smarty version 2.6.18, created on 2014-12-04 13:32:02
         compiled from /var/customers/webs/strauchyve/derAdvokat/tpl/anstell_vertrag_aushilfe.tpl */ ?>
<script type="text/javascript" src="/derAdvokat/js/dyn_felder.js"></script>
<h1>Einstellungsvertrag f&uuml;r Aushilfe</h1>
...
<br />
<table border="0" width="100%" cellpadding="5" class="contenttable">
<?php if (strlen ( $this->_tpl_vars['msg_arbeitszeit'] )): ?>
<tr>
	<td colspan="4" class="fehlermeldung"><?php echo $this->_tpl_vars['msg_arbeitszeit']; ?>
</td>
</tr>
<?php endif; ?>
<tr>
...
<tr>
	...
	<td colspan="3"><input type="text" name="funktion" <?php if (strlen ( $this->_tpl_vars['msg_funktion'] )): ?>class="error"<?php endif; ?> value="<?php if (isset ( $_POST['funktion'] )): ?><?php echo $_POST['funktion']; ?>
<?php endif; ?>" size="20" /></td>
</tr>
<tr>
	<td width="170">Wochenarbeitszeit*</td>
	<td colspan="3"><input type="text" name="arbeitszeit" <?php if (strlen ( $this->_tpl_vars['msg_arbeitszeit'] )): ?>class="error"<?php endif; ?> value="<?php if (isset ( $_POST['arbeitszeit'] )): ?><?php echo $_POST['arbeitszeit']; ?>
<?php endif; ?>" size="5" /> Stunden</td>
</tr>
</table>
<br />
<table border="0" width="100%" cellpadding="5" class="contenttable">
...
<tr>
	<td colspan="3" class="fehlermeldung"><?php echo $this->_tpl_vars['msg_vergutung']; ?>
</td>
</tr>
<?php endif; ?>
<tr>
	<td colspan="3" bgcolor="#9FC6FF"><font color="white"><b>Verg&uuml;tung</b></font></td>
</tr>
<tr>
	<td width="170" rowspan="2">Art der Verg&uuml;tung und H&ouml;he*</td>
	<td><input type="radio" name="art_vergutung"  value="1" onclick="check_anstellung_arbeitsstunden_aushilfe()"  <?php if ($_POST['art_vergutung'] == 1): ?> checked="checked" <?php endif; ?> /> Monatsbruttogehalt in H&ouml;he von </td>
	<td><input type="text" name="gehalt_monats_brutto" <?php if (strlen ( $this->_tpl_vars['msg_vergutung'] )): ?>class="error"<?php endif; ?> value="<?php if (isset ( $_POST['gehalt_monats_brutto'] )): ?><?php echo $_POST['gehalt_monats_brutto']; ?>
<?php endif; ?>" size="20" /> &euro;</td>
</tr>
<tr>
	<td><input type="radio" name="art_vergutung"  value="2" onclick="check_anstellung_arbeitsstunden_aushilfe()" <?php if ($_POST['art_vergutung'] == 2): ?> checked="checked" <?php endif; ?> />Bruttostundenlohn in H&ouml;he von </td>
	<td><input type="text" name="gehalt_stunden_brutto" <?php if (strlen ( $this->_tpl_vars['msg_vergutung'] )): ?>class="error"<?php endif; ?> value="<?php if (isset ( $_POST['gehalt_stunden_brutto'] )): ?><?php echo $_POST['gehalt_stunden_brutto']; ?>
<?php endif; ?>" size="20" /> &euro;</td>
</tr>
</table>
<br />
