<?php /* Smarty version 2.6.18, created on 2014-12-01 13:56:43
         compiled from /var/customers/webs/strauchyve/derAdvokat/tpl/anstell_vertrag_befristet.tpl */ ?>
...
<tr>
	...
	<td><input type="text" name="titel" value="<?php if (isset ( $_POST['titel'] )): ?><?php echo $_POST['titel']; ?>
 <?php else: ?><?php echo $this->_tpl_vars['titel']; ?>
<?php endif; ?>" /></td>
</tr>
<tr>
	<td>Nachname*</td>
...
<tr>
	<td colspan="3" class="fehlermeldung"><?php echo $this->_tpl_vars['msg_dar']; ?>
</td>
</tr>
<?php endif; ?>
<tr>
...
<tr>
	...
	<td>befristet vom <br />nach § 14 TzBfG <input type="text" name="beginn" <?php if (strlen ( $this->_tpl_vars['msg_beginn'] )): ?>class="error"<?php endif; ?> <?php if (isset ( $_POST['beginn'] )): ?>value="<?php echo $_POST['beginn']; ?>
"<?php else: ?>value="TT.MM.JJJJ" onfocus="this.value = ''"<?php endif; ?> size="20" /></td>
	<td><br />bis zum <input type="text" name="bis" <?php if (strlen ( $this->_tpl_vars['msg_bis'] )): ?>class="error"<?php endif; ?> <?php if (isset ( $_POST['bis'] )): ?>value="<?php echo $_POST['bis']; ?>
"<?php else: ?>value="TT.MM.JJJJ" onfocus="this.value = ''"<?php endif; ?> size="20" /></td>	
</tr>
</table>
<br />
...
<br />
<table border="0" width="100%" cellpadding="5" class="contenttable">
<?php if (strlen ( $this->_tpl_vars['msg_urlaub'] )): ?>
<tr>
	<td colspan="4" class="fehlermeldung"><?php echo $this->_tpl_vars['msg_urlaub']; ?>
</td>
</tr>
<?php endif; ?>
<tr>
...
<tr>
	...
	<td colspan="3"><input type="text" name="urlaub" <?php if (strlen ( $this->_tpl_vars['msg_urlaub'] )): ?>class="error"<?php endif; ?> value="<?php if (isset ( $_POST['urlaub'] )): ?><?php echo $_POST['urlaub']; ?>
<?php endif; ?>" size="20" /></td>
</tr>
</table>
<br />
