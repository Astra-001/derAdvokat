...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', '/var/customers/webs/strauchyve/derAdvokat/tpl/log.tpl', 19, false),)), $this); ?>
...
<!-- MITGLIEDERBEZOGENE MONITORING -->
	...
	<div style="height:auto;max-height:200px;overflow-y:scroll;">
		...
		<?php $_from = $this->_tpl_vars['logsArray'][$this->_tpl_vars['u']['id']]; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['logsArray'] = array('total' => count($_from), 'iteration' => 0);
