<?php /* Smarty version 2.6.18, created on 2020-05-27 15:02:57
         compiled from /var/customers/webs/strauchyve/derAdvokat/tpl/anstell_vertrag_verlangerung.tpl */ ?>
...
<tr>
	<td colspan="2" class="fehlermeldung"><?php echo $this->_tpl_vars['msg_dar']; ?>
</td>
</tr>
<?php endif; ?>
<tr>
...
<tr>
	...
	<td><input type="text" name="beginn" <?php if (strlen ( $this->_tpl_vars['msg_beginn'] )): ?>class="error"<?php endif; ?> <?php if (isset ( $_POST['beginn'] )): ?>value="<?php echo $_POST['beginn']; ?>
"<?php else: ?>value="TT.MM.JJJJ" onfocus="this.value = ''"<?php endif; ?> size="20" /></td>
</tr>
<tr>
	<td width="170">Verl&auml;ngerung bis zum </td>
	<td><input type="text" name="verlangerung" <?php if (strlen ( $this->_tpl_vars['msg_verlangerung'] )): ?>class="error"<?php endif; ?> <?php if (isset ( $_POST['verlangerung'] )): ?>value="<?php echo $_POST['verlangerung']; ?>
"<?php else: ?>value="TT.MM.JJJJ" onfocus="this.value = ''"<?php endif; ?>" size="20" /></td>
</tr>
<tr>
	<td width="170">Um welche Verl&auml;ngerung handelt es sich?</td>
	<td><select name="anzahl">
        <option value="1" <?php if ($_POST['anzahl'] == 1): ?> selected="selected" <?php endif; ?>>erste</option>
        <option value="2" <?php if ($_POST['anzahl'] == 2): ?> selected="selected" <?php endif; ?>>zweite</option>
        <option value="3" <?php if ($_POST['anzahl'] == 3): ?> selected="selected" <?php endif; ?>>dritte</option>
    </select></td>
</tr>
</table>
<br />
