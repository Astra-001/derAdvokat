...
if($_POST['einstellung_allg'])
{
	...
	if ($_POST['ex_strasse']=='')
	{
	    $msg_ex_strasse = "Bitte geben Sie - Strasse - ein";
	    $smarty->assign('msg', $msg_ex_strasse);
	    $smarty->assign('msg_strasse', $msg_ex_strasse);
	}
	if ($_POST['ex_vorname']=='')
	{
	...
	if(!isset($msg_person) AND !isset($msg_name) AND !isset($msg_vorname) AND !isset($msg_strasse) AND !isset($msg_plz) AND !isset($msg_ort) AND !isset($msg_beginn) AND !isset($msg_bereich) AND !isset($msg_gehalt) AND !isset($msg_ubernachtung) AND !isset($msg_verpflegung) AND !isset($msg_urlaub))
	{
	  	require_once("rtf/einstellungsvertrag_ad_rtf.php");
	}
}
else
{
...
$smarty->assign('contentTemplate', 'anstell_vertrag_ad.tpl');