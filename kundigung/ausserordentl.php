...
$parPar->setSpaceAfter(15);	
	...
	$parPar->setIndentLeft(0);
	$parPar->setSpaceAfter(0);
	$absatz1 = "hiermit beendigen wir das mit Ihnen seit dem ".$_POST['datum_begin']." bestehende Arbeitsverhältnis fristlos mit sofortiger Wirkung, hilfsweise fristgerecht zum nächstmöglichen Termin, nach unseren Unterlagen der ".$_POST['daterez'].". Durch Ihr Verhalten ist unser Vertrauensverhältnis zu Ihnen nachhaltig gestört und wir sehen uns nicht mehr in der Lage, Sie weiterhin zu beschäftigen. ";
	...
	$absatz3 = "Soweit Ihnen Arbeitskleidung oder Gegenstände überlassen wurden und sich noch in Ihrem Besitz befinden, bitten wir diese unverzüglich zurückzugeben.";
    ...
    $parCellTabl = new ParFormat('justify');
...
$rtf->sendRtf('kuendigung_ausserordentl_'.date('Y-m-d_H-i-s'));
#}
?>
